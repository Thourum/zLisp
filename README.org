...
* zLisp
See [[file:doc/zLisp_paper.org][docs]] or [[file:docs/Extending The Functionality Of A Running C# Program Using Auxiliary High-Level Interpreted Language.pdf][paper.pdf]]
** Introduction
